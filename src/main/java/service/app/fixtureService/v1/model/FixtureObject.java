package service.app.fixtureService.v1.model;
...
/**
 * A class to represent a fixtureService in football.
 * This class is used to store information about a fixtureService, such as the teams playing, the score, the status, and the odds.
 */
public class FixtureObject {
    ...
    /** The unique identifier for the fixtureService. */
    ...
    /** The date of the fixtureService. */
    final private @NotNull String fixture_date;

    /** The status of the fixtureService. */
    final private @NotNull Map<String, String> status;

    /** The teams playing in the fixtureService. */
    ...
    /** The odds for the fixtureService. */
    ...
    public FixtureObject(JsonElement input) throws JsonParseException {
        ...
        try {
            ...
            logger.error("Could not retrieve fixtureService information: {}", e.getMessage());
            throw new JsonParseException("Could not retrieve fixtureService information");
        }
    ...
    /**
     * Returns the fixtureService id. This is a unique identifier for the fixtureService.
     * @return the fixtureService id
     */
    ...
    /**
     * Returns the odds for the fixtureService. If the odds are not present, it returns an empty Optional.
     * @return the odds for the fixtureService
     */
    @SuppressWarnings("unused")
    ...
    /**
     * Sets the odds for the fixtureService.
     * @param odds the odds for the fixtureService
     */
    public void setFixtureBets(FixtureBetsObject odds) {
        if (odds == null) {
            logger.warn("Attempted to set null odds for fixtureService with ID: {}", this.fixture_id);
        }
        this.odds = odds;
    }
    ...
    /**
     * Returns a JSON representation of the fixtureService.
     * This method creates a JSON object that includes all relevant fixtureService details,
     * making it easy to serialize fixtureService data for API responses or data storage.
     *
     * @return the JSON representation of the fixtureService
     */
    ...
    /**
     * Adds basic fixtureService details to the JSON object.
    ...
    private void addOddsDetails(JsonObject json) {
        if (odds != null) {
            ...
            json.addProperty("odds", "No odds available for this fixtureService");
        }
    }
