...
/* The bets available for a fixtureService
...
public class FixtureBetsObject {
    ...
    public FixtureBetsObject(JsonElement input) {
        ...
        // loop through "bookmakers" in fixtureService
    ...
    public String toFormattedString() {
        ...
        try {
            ...
            return "No odds available for fixtureService: " + fixtureID + " | Bookmaker: " + bookmaker;
        }
    }
    ...
    /**
     * Converts the odds to JSON. The fixtureService ID is not passed on as it is already available in the fixtureService object.
